...
namespace GardenDefence
{
    ...
    public class LevelController : MonoBehaviour
    {
        ...
        [SerializeField] private EnemyKillCounter _enemiesCounter;
        ...
        private void Subscribe()
        {
            ...
            _enemiesCounter.EnemyKilled += OnEnemyKilled;
        ...
        {
            _enemiesOnLevel--;
            if (_enemiesOnLevel <= Mathf.Epsilon && _levelTimerFinished)
        ...
        private IEnumerator HandleWinCondition()
        {
            ...
            if (_enemiesOnLevel > Mathf.Epsilon) yield break;
